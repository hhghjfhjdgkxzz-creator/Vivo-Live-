               ...
               >
                 ...
                 <div className="flex items-center gap-4 relative z-10">
                    <div className="relative w-16 h-16 flex-shrink-0">
                       ...
                       <img src={vip.frameUrl || 'https://cdn-icons-png.flaticon.com/512/763/763328.png'} className="absolute inset-0 w-full h-full object-contain pointer-events-none drop-shadow-lg scale-[1.2]" alt={vip.name} />
